import{_ as n,o as s,c as a,e as p}from"./app-yKfIKdw2.js";const t={},e=p(`<h1 id="javascript" tabindex="-1"><a class="header-anchor" href="#javascript" aria-hidden="true">#</a> JavaScript</h1><h2 id="javascript数学工具" tabindex="-1"><a class="header-anchor" href="#javascript数学工具" aria-hidden="true">#</a> JavaScript数学工具</h2><details class="custom-container details"><summary>JavaScript数学工具模块</summary><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 获取最大小数精度

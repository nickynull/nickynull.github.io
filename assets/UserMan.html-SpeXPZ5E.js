import{_ as s,r as i,o as d,c as l,a as e,d as n,b as c,j as r}from"./app-CVeYDNBN.js";const o={},t=e("h1",{id:"用户管理",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#用户管理","aria-hidden":"true"},"#"),n(" 用户管理")],-1),u={href:"https://man.niaoge.com/",target:"_blank",rel:"noopener noreferrer"},p=r(`<h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 用户管理</span>

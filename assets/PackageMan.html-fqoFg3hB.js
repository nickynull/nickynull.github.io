import{_ as i,r as t,o as c,c as o,a as n,d as s,b as e,e as l}from"./app-vQfHfLyG.js";const p={},d=n("h1",{id:"linux-包管理器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#linux-包管理器","aria-hidden":"true"},"#"),s(" Linux 包管理器")],-1),r=n("h2",{id:"yum",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#yum","aria-hidden":"true"},"#"),s(" yum")],-1),u={href:"https://www.runoob.com/linux/linux-yum.html",target:"_blank",rel:"noopener noreferrer"},m=l(`<blockquote><p>yum（ Yellow dog Updater, Modified）是一个在 Fedora 和 RedHat 以及 SUSE 中的 Shell 前端软件包管理器。<br> 基于 RPM 包管理，能够从指定的服务器自动下载 RPM 包并且安装，可以自动处理依赖性关系，并且一次安装所有依赖的软件包，无须繁琐地一次次下载、安装。</p></blockquote><h3 id="yum-常用命令" tabindex="-1"><a class="header-anchor" href="#yum-常用命令" aria-hidden="true">#</a> yum 常用命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 列出所有可更新的软件清单命令：</span>
yum check-update

import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as l,o as e}from"./app-BzR1ktM_.js";const p={};function o(c,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="linux-包管理器" tabindex="-1"><a class="header-anchor" href="#linux-包管理器"><span>Linux 包管理器</span></a></h1><h2 id="yum" tabindex="-1"><a class="header-anchor" href="#yum"><span>yum</span></a></h2><p><a href="https://www.runoob.com/linux/linux-yum.html" target="_blank" rel="noopener noreferrer">菜鸟教程 - Linux yum 命令 | https://www.runoob.com/linux/linux-yum.html</a></p><blockquote><p>yum（ Yellow dog Updater, Modified）是一个在 Fedora 和 RedHat 以及 SUSE 中的 Shell 前端软件包管理器。<br> 基于 RPM 包管理，能够从指定的服务器自动下载 RPM 包并且安装，可以自动处理依赖性关系，并且一次安装所有依赖的软件包，无须繁琐地一次次下载、安装。</p></blockquote><h3 id="yum-常用命令" tabindex="-1"><a class="header-anchor" href="#yum-常用命令"><span>yum 常用命令</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#272822;color:#F8F8F2;"><pre class="shiki monokai vp-code"><code><span class="line"><span style="color:#88846F;"># 列出所有可更新的软件清单命令：</span></span>
